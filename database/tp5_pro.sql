...
-- ----------------------------
INSERT INTO `tp5_xadmin_roles` VALUES ('1', '终级管理员', '1|7|6|2|3|73|4|5|49|48|50|67|61|', '2019-07-09 17:23:17', '1');
...
-- ----------------------------
INSERT INTO `tp5_xarticle_points` VALUES ('1', '1', '2', '', '/home/images/article1.png', '如今科技进步，时代向前，人的平均寿命越来越长了。但长长的一生中，究竟有多少时间真正属于我们自己呢？', '1');
...
CREATE TABLE `tp5_xnav_menus` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=92 DEFAULT CHARSET=utf8mb4 COMMENT='菜单导航表';
...
CREATE TABLE `tp5_xskus` (
  ...
  PRIMARY KEY (`sku_id`)
) ENGINE=MyISAM AUTO_INCREMENT=60 DEFAULT CHARSET=utf8mb4 COMMENT='商品 SKU 库存表\r\n\r\n用于存储商品不同属性搭配的数目、价格等';
